...
mapa = {
        ...
        '1'                   : { 'lista_habitaciones' :  ['Spawn', '3', '4'], 'lista_items' : ["Replica"] },
        '2'                   : { 'lista_habitaciones' :  ['Spawn', '4'],      'lista_items' : [] },
        '3'                   : { 'lista_habitaciones' :  ['1'],               'lista_items' : [] }, # <<--- AGREGAR ITEM NECESARIO A ESTA SALA
        '4'                   : { 'lista_habitaciones' :  ['1', '2', 'Boss'],  'lista_items' : ["Chocolate"] },
...
item_requerido = "Arma Legendaria" # Necesitaremos un "Arma Legendaria" para derrotar al Boss
...
while (not (boss_derrotado and (habitacion_actual == "Salida"))):
